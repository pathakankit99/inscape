...
function Index() {
  ...
  return (
    <div className="w-full pt-12  bg-gray-900 md:h-70vh relative">
      <div className=" relative flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
        <svg
        ...
        <div
          className="container2 w-full sm:w-2/3 "
          data-aos="fade-up"
          data-aos-duration={1000}
          data-aos-delay=".3s"
          style={{ visibility: "visible", animationDelay: "0.3s" }}
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl md:text-center text-white font-bold leading-tight">
